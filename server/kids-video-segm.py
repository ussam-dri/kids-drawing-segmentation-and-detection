...
def run_pipeline():
    ...
    try:
        pipeline = InferencePipeline.init_with_workflow(
            api_key="7kDS0qoq56Si0jbdcRHV",# change to your API key
            workspace_name="wisd-scixc", # change to your workspace name
            workflow_id="custom-workflow-6",# change to your workflow ID
